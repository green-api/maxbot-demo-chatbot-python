...
class EndpointsScene:
    ...
    async def execute(self, n):
        ...
        elif text_lower in ["стоп", "stop", "0", "/stop"]:
            await n.reply(
        ...
        elif text_lower in ["menu", "меню", "/menu"]:
