...
* [Установка среды для запуска](#установка-среды-для-запуска)
...
Для работы бота требуется **Python версии 3.10** или выше. Скачать актуальную версию можно с [официального сайта python.org](https://www.python.org/downloads/).
...
Скачайте и разархивируйте [zip-архив](https://github.com/green-api/maxbot-demo-chatbot-python) проекта:
